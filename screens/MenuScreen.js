...
const menuItems = [
  ...
  { label: 'CREAR CUENTA', icon: require('../assets/ico-cuentas.png'), route: '/crearcuenta', accion: 'cuenta' },
  { label: 'CREAR SOCIO', icon: require('../assets/ico-clientes.png'), route: '/crearcliente', accion: 'cliente' },
